	...
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row" align="center"><h3>Account Balance</h3></div>
				...
				<hr style="max-width: 600px; background-color: : red; border-color: #7c7c7c;">
				<div class="container">
					<h2>Welcome to ABBC Online Shopping!</h2>
					...
					<div class="container" id="shopping-container">
						<div class="row">
							<div class="col-sm-4">
								<div class="thumbnail">
									<img src="img/ebay.png" class="">
									<div class="caption">
										<h4 class="">EBAY</h4>

										<p class="">Retailer Details</p> <a href="#" class="btn btn-default btn-xs pull-right" role="button"><i class="glyphicon glyphicon-edit"></i></a>  <a href="#" class="btn btn-primary btn-sm" role="button">Go Shopping</a>
							...
							<div class="col-sm-4">
								<div class="thumbnail">
									<img src="img/loftybuy.jpg" class="">
									<div class="caption">
										<h4 class="">Loftbuy</h4>
