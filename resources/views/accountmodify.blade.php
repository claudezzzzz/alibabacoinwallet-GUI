		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
								...
								<form action="/landing" role="form">
									<div class="form-group">
										<div class="input-group login-textfield">
											...
											<input type="text" class="form-control text-line" placeholder="Username" value="username" />
										</div>
									</div>
									<div class="form-group">
										<div class="input-group login-textfield">
									...
									<div class="form-group">
										<div class="input-group login-textfield">
											...
											<input type="password" class="form-control text-line" placeholder="Repeat Password" />
									...
									<div class="form-group text-center login-button">
										<button type="submit" class="btn btn-success btn-sm btn-login">MODIFY FACE RECOGNITION</button>
									</div>
				...
				<div class="row" align="center">
					...
					<div class="form-group text-center login-button">
						<button type="submit" class="btn btn-success btn-sm btn-login">Save Changes</button>
					</div>
				</div>
