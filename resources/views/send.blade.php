								...
								<form action="/landing" role="form">
									<div class="form-group">
										<div class="input-group login-textfield">
											...
											<input type="text" class="form-control text-line" placeholder="Amount" />
										</div>
									</div>
									<div class="form-group">
										<div class="input-group login-textfield">
											...
											<input type="text" class="form-control text-line" placeholder="Total Send Value" disabled />
										</div>
									</div>
									<div class="form-group">
										<div class="input-group login-textfield">
											...
											<input type="text" class="form-control text-line" placeholder="Address" />
									...
									<div class="form-group text-center login-button">
										<button type="" class="btn btn-success btn-sm btn-login">QRCODE SCAN</button>
										<button type="" class="btn btn-success btn-sm btn-login">SEND</button>
