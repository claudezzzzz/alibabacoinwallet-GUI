						...
						<div class="modal-content">
							...
							<div class="modal-body" align="center">
								<form action="/landing" role="form">
									<div class="row exchange-row" align="center">
										...
										<div class="col-lg-4 col-sm-2">
											...
											<div class="form-group">
												...
												<select class="form-control form-control-sm" id="exampleFormControlSelect1">
													<option style="background-image:url(img/btccash.png)";>ABBC</option>
									...
									<div class="form-group">
										<div class="input-group login-textfield">
											...
											<input type="text" class="form-control text-line" placeholder="Enter Amount" onkeyup="digitsOnly(this);" />
										</div>
									</div>
									<br>
									<div class="row" align="center">
										<button type="" class="btn btn-success btn-sm btn-login">EXCHANGE</button>
									</div>
